...
.. autoapisummary::
   ...
   dist_layers.LogBinomial
   dist_layers.ConditionalLogBinomial
...
.. autoapisummary::
   ...
   dist_layers.log_binom



.. py:function:: log_binom(n, k, eps=1e-07)

   log(nCk) using stirling approximation


.. py:class:: LogBinomial(n_classes=256, act=torch.softmax)
   ...
   .. py:method:: forward(x, t=1.0, eps=0.0001)

      Compute log binomial distribution for x

      :param x: probabilities
      :type x: torch.Tensor - NCHW
      :param t: Temperature of distribution. Defaults to 1..
      :type t: float, torch.Tensor - NCHW, optional
      :param eps: Small number for numerical stability. Defaults to 1e-4.
      :type eps: float, optional

      :returns: log binomial distribution logbinomial(p;t)
      :rtype: torch.Tensor -NCHW
...
.. py:class:: ConditionalLogBinomial(in_features, condition_dim, n_classes=256, bottleneck_factor=2, p_eps=0.0001, max_temp=50, min_temp=1e-07, act=torch.softmax)
   ...
   .. py:method:: forward(x, cond)

      Forward pass

      :param x: Main feature
      :type x: torch.Tensor - NCHW
      :param cond: condition feature
      :type cond: torch.Tensor - NCHW

      :returns: Output log binomial distribution
      :rtype: torch.Tensor
