:py:mod:`patch_transformer`
===========================

.. py:module:: patch_transformer
...
.. py:class:: PatchTransformerEncoder(in_channels, patch_size=10, embedding_dim=128, num_heads=4, use_class_token=False)
   ...
   .. py:method:: positional_encoding_1d(sequence_length, batch_size, embedding_dim, device='cpu')
   ...
   .. py:method:: forward(x)
      ...
      :returns: Transformer output embeddings. S - sequence length (=HW/patch_size^2), N - batch size, E - embedding dim
      :rtype: torch.Tensor - SNE
