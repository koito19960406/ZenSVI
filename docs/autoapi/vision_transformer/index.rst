:py:mod:`vision_transformer`
============================

.. py:module:: vision_transformer
...
.. autoapisummary::
   ...
   vision_transformer.BlockChunk
   vision_transformer.DinoVisionTransformer
...
.. autoapisummary::
   ...
   vision_transformer.named_apply
   vision_transformer.init_weights_vit_timm
   vision_transformer.vit_small
   vision_transformer.vit_base
   vision_transformer.vit_large
   vision_transformer.vit_giant2
...
.. py:function:: named_apply(fn: Callable, module: torch.nn.Module, name='', depth_first=True, include_root=False) -> torch.nn.Module


.. py:class:: BlockChunk(modules: Optional[Iterable[torch.nn.modules.module.Module]] = None)
   ...
   .. py:method:: __getitem__(idx: Union[int, slice]) -> Union[torch.nn.modules.module.Module, ModuleList]


   .. py:method:: __setitem__(idx: int, module: torch.nn.modules.module.Module) -> None


   .. py:method:: __delitem__(idx: Union[int, slice]) -> None


   .. py:method:: __len__() -> int


   .. py:method:: __iter__() -> Iterator[torch.nn.modules.module.Module]


   .. py:method:: __iadd__(modules: Iterable[torch.nn.modules.module.Module]) -> typing_extensions.Self


   .. py:method:: __add__(other: Iterable[torch.nn.modules.module.Module]) -> ModuleList
   ...
   .. py:method:: insert(index: int, module: torch.nn.modules.module.Module) -> None
   ...
   .. py:method:: append(module: torch.nn.modules.module.Module) -> ModuleList
   ...
   .. py:method:: pop(key: Union[int, slice]) -> torch.nn.modules.module.Module


   .. py:method:: extend(modules: Iterable[torch.nn.modules.module.Module]) -> typing_extensions.Self
...
.. py:class:: DinoVisionTransformer(img_size=224, patch_size=16, in_chans=3, embed_dim=768, depth=12, num_heads=12, mlp_ratio=4.0, qkv_bias=True, ffn_bias=True, proj_bias=True, drop_path_rate=0.0, drop_path_uniform=False, init_values=None, embed_layer=PatchEmbed, act_layer=nn.GELU, block_fn=Block, ffn_layer='mlp', block_chunks=1, num_register_tokens=0, interpolate_antialias=False, interpolate_offset=0.1)
   ...
   .. py:method:: prepare_tokens_with_masks(x, masks=None)


   .. py:method:: forward_features_list(x_list, masks_list)


   .. py:method:: forward_features(x, masks=None)


   .. py:method:: get_intermediate_layers(x: torch.Tensor, n: Union[int, Sequence] = 1, reshape: bool = False, return_class_token: bool = False, norm=True) -> Tuple[Union[torch.Tensor, Tuple[torch.Tensor]]]


   .. py:method:: forward(*args, is_training=False, **kwargs)
...
.. py:function:: init_weights_vit_timm(module: torch.nn.Module, name: str = '')

   ViT weight initialization, original timm impl (for reproducibility)


.. py:function:: vit_small(patch_size=16, num_register_tokens=0, **kwargs)


.. py:function:: vit_base(patch_size=16, num_register_tokens=0, **kwargs)


.. py:function:: vit_large(patch_size=16, num_register_tokens=0, **kwargs)


.. py:function:: vit_giant2(patch_size=16, num_register_tokens=0, **kwargs)
