...
:py:mod:`zensvi.cv.depth_estimation.zoedepth.models.base_models.midas`
======================================================================

.. py:module:: zensvi.cv.depth_estimation.zoedepth.models.base_models.midas
...
.. autoapisummary::
   ...
   zensvi.cv.depth_estimation.zoedepth.models.base_models.midas.Resize
   zensvi.cv.depth_estimation.zoedepth.models.base_models.midas.PrepForMidas
   zensvi.cv.depth_estimation.zoedepth.models.base_models.midas.MidasCore
...
.. autoapisummary::
   ...
   zensvi.cv.depth_estimation.zoedepth.models.base_models.midas.denormalize
   zensvi.cv.depth_estimation.zoedepth.models.base_models.midas.get_activation
...
.. autoapisummary::
   ...
   zensvi.cv.depth_estimation.zoedepth.models.base_models.midas.nchannels2models
   zensvi.cv.depth_estimation.zoedepth.models.base_models.midas.MIDAS_SETTINGS
...
.. py:class:: MidasCore(midas, trainable=False, fetch_features=True, layer_names=('out_conv', 'l4_rn', 'r4', 'r3', 'r2', 'r1'), freeze_bn=False, keep_aspect_ratio=True, img_size=384, **kwargs)
   ...
   .. py:method:: set_output_channels(model_type)


   .. py:method:: build(midas_model_type='DPT_BEiT_L_384', train_midas=False, use_pretrained_midas=True, fetch_features=False, freeze_bn=True, force_keep_ar=False, force_reload=False, **kwargs)
      :staticmethod:
