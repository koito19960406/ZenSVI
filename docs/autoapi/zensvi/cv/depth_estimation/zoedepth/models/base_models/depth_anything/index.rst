...
:py:mod:`zensvi.cv.depth_estimation.zoedepth.models.base_models.depth_anything`
===============================================================================

.. py:module:: zensvi.cv.depth_estimation.zoedepth.models.base_models.depth_anything
...
.. autoapisummary::
   ...
   zensvi.cv.depth_estimation.zoedepth.models.base_models.depth_anything.Resize
   zensvi.cv.depth_estimation.zoedepth.models.base_models.depth_anything.PrepForMidas
   zensvi.cv.depth_estimation.zoedepth.models.base_models.depth_anything.DepthAnythingCore
...
.. autoapisummary::
   ...
   zensvi.cv.depth_estimation.zoedepth.models.base_models.depth_anything.denormalize
   zensvi.cv.depth_estimation.zoedepth.models.base_models.depth_anything.get_activation
...
.. autoapisummary::
   ...
   zensvi.cv.depth_estimation.zoedepth.models.base_models.depth_anything.nchannels2models
   zensvi.cv.depth_estimation.zoedepth.models.base_models.depth_anything.MIDAS_SETTINGS
...
.. py:function:: get_activation(name, bank)


.. py:class:: Resize(width, height, resize_target=True, keep_aspect_ratio=False, ensure_multiple_of=1, resize_method='lower_bound')
...
.. py:class:: PrepForMidas(resize_mode='minimal', keep_aspect_ratio=True, img_size=384, do_resize=True)
...
.. py:class:: DepthAnythingCore(midas, trainable=False, fetch_features=True, layer_names=('out_conv', 'l4_rn', 'r4', 'r3', 'r2', 'r1'), freeze_bn=False, keep_aspect_ratio=True, img_size=384, **kwargs)
   ...
   .. py:method:: set_trainable(trainable)


   .. py:method:: set_fetch_features(fetch_features)
   ...
   .. py:method:: forward(x, denorm=False, return_rel_depth=False)


   .. py:method:: get_rel_pos_params()


   .. py:method:: get_enc_params_except_rel_pos()


   .. py:method:: freeze_encoder(freeze_rel_pos=False)


   .. py:method:: attach_hooks(midas)
   ...
   .. py:method:: set_output_channels()


   .. py:method:: build(midas_model_type='dinov2_large', train_midas=False, use_pretrained_midas=True, fetch_features=False, freeze_bn=True, force_keep_ar=False, force_reload=False, **kwargs)
      :staticmethod:


   .. py:method:: parse_img_size(config)
      :staticmethod:
...
.. py:data:: nchannels2models

   

.. py:data:: MIDAS_SETTINGS
