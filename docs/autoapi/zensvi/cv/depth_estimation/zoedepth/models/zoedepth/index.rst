...
:py:mod:`zensvi.cv.depth_estimation.zoedepth.models.zoedepth`
=============================================================

.. py:module:: zensvi.cv.depth_estimation.zoedepth.models.zoedepth
...
.. autoapisummary::
   ...
   zensvi.cv.depth_estimation.zoedepth.models.zoedepth.ZoeDepth
...
.. autoapisummary::
   ...
   zensvi.cv.depth_estimation.zoedepth.models.zoedepth.all_versions
   zensvi.cv.depth_estimation.zoedepth.models.zoedepth.get_version


.. py:class:: ZoeDepth(core, n_bins=64, bin_centers_type='softplus', bin_embedding_dim=128, min_depth=0.001, max_depth=10, n_attractors=[16, 8, 4, 1], attractor_alpha=300, attractor_gamma=2, attractor_kind='sum', attractor_type='exp', min_temp=5, max_temp=50, train_midas=True, midas_lr_factor=10, encoder_lr_factor=10, pos_enc_lr_factor=10, inverse_midas=False, **kwargs)


   Bases: :py:obj:`zensvi.cv.depth_estimation.zoedepth.models.depth_model.DepthModel`
   ...
   .. py:method:: forward(x, return_final_centers=False, denorm=False, return_probs=False, **kwargs)
      ...
      :type x: torch.Tensor
      :param return_final_centers: Whether to return the final bin centers. Defaults to False.
      :type return_final_centers: bool, optional
      :param denorm: Whether to denormalize the input image. This reverses ImageNet normalization as midas normalization is different. Defaults to False.
      :type denorm: bool, optional
      :param return_probs: Whether to return the output probability distribution. Defaults to False.
   ...
   .. py:method:: to(device) -> torch.nn.Module
   ...
   .. py:method:: infer_with_flip_aug(x, pad_input: bool = True, **kwargs) -> torch.Tensor
      ...
      :type x: torch.Tensor
      :param pad_input: whether to use padding augmentation. Defaults to True.
      :type pad_input: bool, optional

      :returns: output tensor of shape (b, 1, h, w)
      :rtype: torch.Tensor


   .. py:method:: infer(x, pad_input: bool = True, with_flip_aug: bool = True, **kwargs) -> torch.Tensor
      ...
      :param pad_input: whether to use padding augmentation. Defaults to True.
      :type pad_input: bool, optional
      :param with_flip_aug: whether to use horizontal flip augmentation. Defaults to True.
      :type with_flip_aug: bool, optional

      :returns: output tensor of shape (b, 1, h, w)
      :rtype: torch.Tensor


   .. py:method:: infer_pil(pil_img, pad_input: bool = True, with_flip_aug: bool = True, output_type: str = 'numpy', **kwargs) -> Union[numpy.ndarray, PIL.Image.Image, torch.Tensor]
      ...
      :param with_flip_aug: whether to use horizontal flip augmentation. Defaults to True.
      :type with_flip_aug: bool, optional
      :param output_type: output type. Supported values are 'numpy', 'pil' and 'tensor'. Defaults to "numpy".
