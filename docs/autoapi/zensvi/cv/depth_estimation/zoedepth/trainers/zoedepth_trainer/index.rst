:py:mod:`zensvi.cv.depth_estimation.zoedepth.trainers.zoedepth_trainer`
=======================================================================

.. py:module:: zensvi.cv.depth_estimation.zoedepth.trainers.zoedepth_trainer
...
.. autoapisummary::
   ...
   zensvi.cv.depth_estimation.zoedepth.trainers.zoedepth_trainer.Trainer
...
.. py:class:: Trainer(config, model, train_loader, test_loader=None, device=None)
   ...
   .. py:method:: eval_infer(x)


   .. py:method:: crop_aware_infer(x)
