:py:mod:`zensvi.cv.depth_estimation.zoedepth.trainers.loss`
===========================================================

.. py:module:: zensvi.cv.depth_estimation.zoedepth.trainers.loss
...
.. autoapisummary::
   ...
   zensvi.cv.depth_estimation.zoedepth.trainers.loss.SILogLoss
   zensvi.cv.depth_estimation.zoedepth.trainers.loss.GradL1Loss
   zensvi.cv.depth_estimation.zoedepth.trainers.loss.OrdinalRegressionLoss
   zensvi.cv.depth_estimation.zoedepth.trainers.loss.DiscreteNLLLoss
   zensvi.cv.depth_estimation.zoedepth.trainers.loss.ScaleAndShiftInvariantLoss
...
.. autoapisummary::
   ...
   zensvi.cv.depth_estimation.zoedepth.trainers.loss.extract_key
   zensvi.cv.depth_estimation.zoedepth.trainers.loss.grad
   zensvi.cv.depth_estimation.zoedepth.trainers.loss.grad_mask
   zensvi.cv.depth_estimation.zoedepth.trainers.loss.compute_scale_and_shift
...
.. autoapisummary::
   ...
   zensvi.cv.depth_estimation.zoedepth.trainers.loss.KEY_OUTPUT
   zensvi.cv.depth_estimation.zoedepth.trainers.loss.celoss
...
.. py:function:: extract_key(prediction, key)


.. py:class:: SILogLoss(beta=0.15)
   ...
   .. py:method:: forward(input, target, mask=None, interpolate=True, return_interpolated=False)
...
.. py:class:: OrdinalRegressionLoss(ord_num, beta, discretization='SID')


   Bases: :py:obj:`object`

   .. py:method:: __call__(prob, gt)
...
.. py:class:: DiscreteNLLLoss(min_depth=0.001, max_depth=10, depth_bins=64)
   ...
   .. py:method:: quantize_depth(depth)
...
.. py:function:: compute_scale_and_shift(prediction, target, mask)


.. py:class:: ScaleAndShiftInvariantLoss
   ...
   .. py:method:: forward(prediction, target, mask, interpolate=True, return_interpolated=False)
