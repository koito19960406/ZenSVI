:py:mod:`dinov2.eval.knn`
=========================

.. py:module:: dinov2.eval.knn
...
.. autoapisummary::
   ...
   dinov2.eval.knn.KnnModule
   dinov2.eval.knn.DictKeysModule
   dinov2.eval.knn.ModuleDictWithForward
...
.. autoapisummary::
   ...
   dinov2.eval.knn.get_args_parser
   dinov2.eval.knn.create_module_dict
   dinov2.eval.knn.filter_train
   dinov2.eval.knn.create_class_indices_mapping
   dinov2.eval.knn.eval_knn
   dinov2.eval.knn.eval_knn_with_model
   dinov2.eval.knn.main
...
.. autoapisummary::
   ...
   dinov2.eval.knn.logger
   dinov2.eval.knn.description
...
.. py:class:: KnnModule(train_features, train_labels, nb_knn, T, device, num_classes=1000)
   ...
   .. py:method:: compute_neighbors(features_rank)


   .. py:method:: forward(features_rank)
...
.. py:class:: DictKeysModule(keys)
   ...
   .. py:method:: forward(features_dict, targets)
...
.. py:function:: create_module_dict(*, module, n_per_class_list, n_tries, nb_knn, train_features, train_labels)


.. py:function:: filter_train(mapping, n_per_class, seed)


.. py:function:: create_class_indices_mapping(labels)


.. py:class:: ModuleDictWithForward(modules: Optional[Mapping[str, torch.nn.modules.module.Module]] = None)
   ...
   * in :meth:`~torch.nn.ModuleDict.update`, the order of the merged
   ...
   :param modules: a mapping (dictionary) of (string: module)
   ...
   .. py:method:: __getitem__(key: str) -> torch.nn.modules.module.Module


   .. py:method:: __setitem__(key: str, module: torch.nn.modules.module.Module) -> None
   ...
   .. py:method:: pop(key: str) -> torch.nn.modules.module.Module

      Remove key from the ModuleDict and return its module.

      :param key: key to pop from the ModuleDict
      :type key: str
   ...
   .. py:method:: items() -> Iterable[Tuple[str, torch.nn.modules.module.Module]]

      Return an iterable of the ModuleDict key/value pairs.


   .. py:method:: values() -> Iterable[torch.nn.modules.module.Module]

      Return an iterable of the ModuleDict values.


   .. py:method:: update(modules: Mapping[str, torch.nn.modules.module.Module]) -> None
      ...
      :param modules: a mapping (dictionary) from string to :class:`~torch.nn.Module`,
...
.. py:function:: eval_knn(model, train_dataset, val_dataset, accuracy_averaging, nb_knn, temperature, batch_size, num_workers, gather_on_cpu, n_per_class_list=[-1], n_tries=1)


.. py:function:: eval_knn_with_model(model, output_dir, train_dataset_str='ImageNet:split=TRAIN', val_dataset_str='ImageNet:split=VAL', nb_knn=(10, 20, 100, 200), temperature=0.07, autocast_dtype=torch.float, accuracy_averaging=AccuracyAveraging.MEAN_ACCURACY, transform=None, gather_on_cpu=False, batch_size=256, num_workers=5, n_per_class_list=[-1], n_tries=1)
