:py:mod:`dinov2.eval.log_regression`
====================================

.. py:module:: dinov2.eval.log_regression
...
.. autoapisummary::
   ...
   dinov2.eval.log_regression.LogRegModule
...
.. autoapisummary::
   ...
   dinov2.eval.log_regression.get_args_parser
   dinov2.eval.log_regression.evaluate_model
   dinov2.eval.log_regression.train_for_C
   dinov2.eval.log_regression.train_and_evaluate
   dinov2.eval.log_regression.sweep_C_values
   dinov2.eval.log_regression.eval_log_regression
   dinov2.eval.log_regression.eval_log_regression_with_model
   dinov2.eval.log_regression.main
...
.. autoapisummary::
   ...
   dinov2.eval.log_regression.logger
   dinov2.eval.log_regression.DEFAULT_MAX_ITER
   dinov2.eval.log_regression.C_POWER_RANGE
   dinov2.eval.log_regression.description
...
.. py:data:: DEFAULT_MAX_ITER
   :value: 1000

   

.. py:data:: C_POWER_RANGE
...
.. py:class:: LogRegModule(C, max_iter=DEFAULT_MAX_ITER, dtype=torch.float64, device=_CPU_DEVICE)
   ...
   .. py:method:: fit(train_features, train_labels)
...
.. py:function:: evaluate_model(*, logreg_model, logreg_metric, test_data_loader, device)


.. py:function:: train_for_C(*, C, max_iter, train_features, train_labels, dtype=torch.float64, device=_CPU_DEVICE)


.. py:function:: train_and_evaluate(*, C, max_iter, train_features, train_labels, logreg_metric, test_data_loader, train_dtype=torch.float64, train_features_device, eval_device)


.. py:function:: sweep_C_values(*, train_features, train_labels, test_data_loader, metric_type, num_classes, train_dtype=torch.float64, train_features_device=_CPU_DEVICE, max_train_iters=DEFAULT_MAX_ITER)


.. py:function:: eval_log_regression(*, model, train_dataset, val_dataset, finetune_dataset, metric_type, batch_size, num_workers, finetune_on_val=False, train_dtype=torch.float64, train_features_device=_CPU_DEVICE, max_train_iters=DEFAULT_MAX_ITER)
...
.. py:function:: eval_log_regression_with_model(model, train_dataset_str='ImageNet:split=TRAIN', val_dataset_str='ImageNet:split=VAL', finetune_dataset_str=None, autocast_dtype=torch.float, finetune_on_val=False, metric_type=MetricType.MEAN_ACCURACY, train_dtype=torch.float64, train_features_device=_CPU_DEVICE, max_train_iters=DEFAULT_MAX_ITER)
...
.. py:data:: description
   :value: 'DINOv2 logistic regression evaluation'
