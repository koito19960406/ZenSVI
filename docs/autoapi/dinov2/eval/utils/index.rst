:py:mod:`dinov2.eval.utils`
===========================

.. py:module:: dinov2.eval.utils
...
.. autoapisummary::
   ...
   dinov2.eval.utils.ModelWithNormalize
   dinov2.eval.utils.ModelWithIntermediateLayers
...
.. autoapisummary::
   ...
   dinov2.eval.utils.evaluate
   dinov2.eval.utils.all_gather_and_flatten
   dinov2.eval.utils.extract_features
   dinov2.eval.utils.extract_features_with_dataloader
...
.. py:class:: ModelWithNormalize(model)
...
.. py:class:: ModelWithIntermediateLayers(feature_model, n_last_blocks, autocast_ctx)
...
.. py:function:: evaluate(model: torch.nn.Module, data_loader, postprocessors: Dict[str, torch.nn.Module], metrics: Dict[str, torchmetrics.MetricCollection], device: torch.device, criterion: Optional[torch.nn.Module] = None)


.. py:function:: all_gather_and_flatten(tensor_rank)


.. py:function:: extract_features(model, dataset, batch_size, num_workers, gather_on_cpu=False)


.. py:function:: extract_features_with_dataloader(model, data_loader, sample_count, gather_on_cpu=False)
