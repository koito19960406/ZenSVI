:py:mod:`dinov2.data.transforms`
================================

.. py:module:: dinov2.data.transforms
...
.. autoapisummary::
   ...
   dinov2.data.transforms.GaussianBlur
   dinov2.data.transforms.MaybeToTensor
...
.. autoapisummary::
   ...
   dinov2.data.transforms.make_normalize_transform
   dinov2.data.transforms.make_classification_train_transform
   dinov2.data.transforms.make_classification_eval_transform
...
.. autoapisummary::
   ...
   dinov2.data.transforms.IMAGENET_DEFAULT_MEAN
   dinov2.data.transforms.IMAGENET_DEFAULT_STD


.. py:class:: GaussianBlur(*, p: float = 0.5, radius_min: float = 0.1, radius_max: float = 2.0)


   Bases: :py:obj:`torchvision.transforms.RandomApply`
...
.. py:class:: MaybeToTensor


   Bases: :py:obj:`torchvision.transforms.ToTensor`

   Convert a ``PIL Image`` or ``numpy.ndarray`` to tensor, or keep as is if already a tensor.

   .. py:method:: __call__(pic)

      :param pic: Image to be converted to tensor.
      :type pic: PIL Image, numpy.ndarray or torch.tensor
...
.. py:data:: IMAGENET_DEFAULT_MEAN
   :value: (0.485, 0.456, 0.406)

   

.. py:data:: IMAGENET_DEFAULT_STD
   :value: (0.229, 0.224, 0.225)

   

.. py:function:: make_normalize_transform(mean: Sequence[float] = IMAGENET_DEFAULT_MEAN, std: Sequence[float] = IMAGENET_DEFAULT_STD) -> torchvision.transforms.Normalize


.. py:function:: make_classification_train_transform(*, crop_size: int = 224, interpolation=transforms.InterpolationMode.BICUBIC, hflip_prob: float = 0.5, mean: Sequence[float] = IMAGENET_DEFAULT_MEAN, std: Sequence[float] = IMAGENET_DEFAULT_STD)


.. py:function:: make_classification_eval_transform(*, resize_size: int = 256, interpolation=transforms.InterpolationMode.BICUBIC, crop_size: int = 224, mean: Sequence[float] = IMAGENET_DEFAULT_MEAN, std: Sequence[float] = IMAGENET_DEFAULT_STD) -> torchvision.transforms.Compose
