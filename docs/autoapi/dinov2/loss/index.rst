...
.. toctree::
   ...
   dino_clstoken_loss/index.rst
   ibot_patch_loss/index.rst
   koleo_loss/index.rst
...
.. autoapisummary::
   ...
   dinov2.loss.DINOLoss
   dinov2.loss.iBOTPatchLoss
   dinov2.loss.KoLeoLoss




.. py:class:: DINOLoss(out_dim, student_temp=0.1, center_momentum=0.9)
   ...
   .. py:method:: softmax_center_teacher(teacher_output, teacher_temp)


   .. py:method:: sinkhorn_knopp_teacher(teacher_output, teacher_temp, n_iterations=3)


   .. py:method:: forward(student_output_list, teacher_out_softmaxed_centered_list)

      Cross-entropy between softmax outputs of the teacher and student networks.


   .. py:method:: update_center(teacher_output)


   .. py:method:: reduce_center_update(teacher_output)


   .. py:method:: apply_center_update()
...
.. py:class:: iBOTPatchLoss(patch_out_dim, student_temp=0.1, center_momentum=0.9)
   ...
   .. py:method:: softmax_center_teacher(teacher_patch_tokens, teacher_temp)


   .. py:method:: sinkhorn_knopp_teacher(teacher_output, teacher_temp, n_masked_patches_tensor, n_iterations=3)


   .. py:method:: forward(student_patch_tokens, teacher_patch_tokens, student_masks_flat)
   ...
   .. py:method:: forward_masked(student_patch_tokens_masked, teacher_patch_tokens_masked, student_masks_flat, n_masked_patches=None, masks_weight=None)


   .. py:method:: update_center(teacher_patch_tokens)


   .. py:method:: reduce_center_update(teacher_patch_tokens)
...
.. py:class:: KoLeoLoss
   ...
   .. py:method:: pairwise_NNs_inner(x)

      Pairwise nearest neighbors for L2-normalized vectors.
      Uses Torch rather than Faiss to remain on GPU.


   .. py:method:: forward(student_output, eps=1e-08)

      :param student_output: backbone output of student
      :type student_output: BxD
