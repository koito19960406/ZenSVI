:py:mod:`dinov2.layers.attention`
=================================

.. py:module:: dinov2.layers.attention
...
.. autoapisummary::
   ...
   dinov2.layers.attention.Attention
   dinov2.layers.attention.MemEffAttention
...
.. autoapisummary::
   ...
   dinov2.layers.attention.logger
...
.. py:class:: Attention(dim: int, num_heads: int = 8, qkv_bias: bool = False, proj_bias: bool = True, attn_drop: float = 0.0, proj_drop: float = 0.0)
