:py:mod:`dinov2.layers.block`
=============================

.. py:module:: dinov2.layers.block
...
.. autoapisummary::
   ...
   dinov2.layers.block.Block
   dinov2.layers.block.NestedTensorBlock
...
.. autoapisummary::
   ...
   dinov2.layers.block.drop_add_residual_stochastic_depth
   dinov2.layers.block.get_branges_scales
   dinov2.layers.block.add_residual
   dinov2.layers.block.get_attn_bias_and_cat
   dinov2.layers.block.drop_add_residual_stochastic_depth_list
...
.. autoapisummary::
   ...
   dinov2.layers.block.logger
   dinov2.layers.block.XFORMERS_AVAILABLE
   dinov2.layers.block.attn_bias_cache
...
.. py:function:: drop_add_residual_stochastic_depth(x: torch.Tensor, residual_func: Callable[[torch.Tensor], torch.Tensor], sample_drop_ratio: float = 0.0) -> torch.Tensor


.. py:function:: get_branges_scales(x, sample_drop_ratio=0.0)


.. py:function:: add_residual(x, brange, residual, residual_scale_factor, scaling_vector=None)


.. py:data:: attn_bias_cache
   :type: Dict[Tuple, Any]

   

.. py:function:: get_attn_bias_and_cat(x_list, branges=None)

   this will perform the index select, cat the tensors, and provide the attn_bias from cache


.. py:function:: drop_add_residual_stochastic_depth_list(x_list: List[torch.Tensor], residual_func: Callable[[torch.Tensor, Any], torch.Tensor], sample_drop_ratio: float = 0.0, scaling_vector=None) -> torch.Tensor
