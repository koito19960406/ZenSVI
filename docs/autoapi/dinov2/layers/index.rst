:py:mod:`dinov2.layers`
=======================

.. py:module:: dinov2.layers
...
.. toctree::
   ...
   dino_head/index.rst
   drop_path/index.rst
   layer_scale/index.rst
   mlp/index.rst
   patch_embed/index.rst
   swiglu_ffn/index.rst
...
.. autoapisummary::
   ...
   dinov2.layers.DINOHead
   dinov2.layers.Mlp
   dinov2.layers.PatchEmbed
   dinov2.layers.SwiGLUFFN
   dinov2.layers.SwiGLUFFNFused
   dinov2.layers.NestedTensorBlock
   dinov2.layers.MemEffAttention




.. py:class:: DINOHead(in_dim, out_dim, use_bn=False, nlayers=3, hidden_dim=2048, bottleneck_dim=256, mlp_bias=True)
...
.. py:class:: Mlp(in_features: int, hidden_features: Optional[int] = None, out_features: Optional[int] = None, act_layer: Callable[Ellipsis, torch.nn.Module] = nn.GELU, drop: float = 0.0, bias: bool = True)
...
.. py:class:: PatchEmbed(img_size: Union[int, Tuple[int, int]] = 224, patch_size: Union[int, Tuple[int, int]] = 16, in_chans: int = 3, embed_dim: int = 768, norm_layer: Optional[Callable] = None, flatten_embedding: bool = True)
   ...
   :param patch_size: Patch token size.
...
.. py:class:: NestedTensorBlock(dim: int, num_heads: int, mlp_ratio: float = 4.0, qkv_bias: bool = False, proj_bias: bool = True, ffn_bias: bool = True, drop: float = 0.0, attn_drop: float = 0.0, init_values=None, drop_path: float = 0.0, act_layer: Callable[Ellipsis, torch.nn.Module] = nn.GELU, norm_layer: Callable[Ellipsis, torch.nn.Module] = nn.LayerNorm, attn_class: Callable[Ellipsis, torch.nn.Module] = Attention, ffn_layer: Callable[Ellipsis, torch.nn.Module] = Mlp)
   ...
   .. py:method:: forward_nested(x_list: List[torch.Tensor]) -> List[torch.Tensor]

      x_list contains a list of tensors to nest together and run


   .. py:method:: forward(x_or_x_list)
...
.. py:class:: MemEffAttention(dim: int, num_heads: int = 8, qkv_bias: bool = False, proj_bias: bool = True, attn_drop: float = 0.0, proj_drop: float = 0.0)
   ...
   .. py:method:: forward(x: torch.Tensor, attn_bias=None) -> torch.Tensor
