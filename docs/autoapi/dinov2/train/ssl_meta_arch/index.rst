:py:mod:`dinov2.train.ssl_meta_arch`
====================================

.. py:module:: dinov2.train.ssl_meta_arch
...
.. autoapisummary::
   ...
   dinov2.train.ssl_meta_arch.SSLMetaArch
...
.. autoapisummary::
   ...
   dinov2.train.ssl_meta_arch.XFORMERS_AVAILABLE
   dinov2.train.ssl_meta_arch.logger
...
.. py:class:: SSLMetaArch(cfg)
   ...
   .. py:method:: backprop_loss(loss)


   .. py:method:: forward_backward(images, teacher_temp)


   .. py:method:: fsdp_synchronize_streams()


   .. py:method:: update_teacher(m)
   ...
   .. py:method:: get_maybe_fused_params_for_submodel(m)


   .. py:method:: get_params_groups()


   .. py:method:: prepare_for_distributed_training()
