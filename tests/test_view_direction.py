...
class TestClassifierViewDirection(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        self.output = "tests/data/output/classification/view_direction"
    ...
    def test_classify_with_mps_device(self):
        device = "mps"
        classifier = ClassifierViewDirection(device=device)
        image_input = "tests/data/input/images"
