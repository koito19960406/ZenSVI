...
class TestKartaView(TestBase):
    ...
    def test_downloader_metadata_only(self):
        ...
        kv_downloader = KVDownloader(
            log_path=os.path.join(self.kv_output_test_polygon_metaonly, "log.log"), max_workers=2000
        )
    ...
    def test_downloader_multipolygon(self):
        ...
        # download images
        kv_downloader = KVDownloader(
            log_path=os.path.join(self.kv_output_test_multipolygon, "log.log"), max_workers=2000
        )
