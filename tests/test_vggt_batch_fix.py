...
def test_batch_processing_generates_separate_files(temp_output_dir, sample_image_files):
    ...
    with patch("zensvi.transform.image_to_pointcloud_vggt.torch"), patch(
        ...
        with patch.object(VGGTProcessor, "__init__", return_value=None):
            ...
            processor._process_batch_to_pointcloud(sample_image_files, image_paths, original_sizes, temp_output_dir)
...
def test_batch_processing_with_single_image(temp_output_dir):
    ...
    with patch("zensvi.transform.image_to_pointcloud_vggt.torch"), patch(
        ...
        with patch.object(VGGTProcessor, "__init__", return_value=None):
            ...
            processor.generate_point_cloud = Mock(
                return_value=(
                    np.array([[1, 2, 3]]),
            ...
            # Call the method
            processor._process_batch_to_pointcloud([image_file], [str(image_file)], [(100, 100)], temp_output_dir)
