...
class ClassifierPlatform(BaseClassifier):
    ...
    def classify(
        ...
        """Classifies images based on platform. The output file can be saved in JSON
        and/or CSV format and will contain platform for each image. The platform
        categories are "driving surface", "walking surface", "cycling surface",
        "tunnel", "field", and "railway".
        ...
        with torch.no_grad():
            results = [
                ...
                for image_files, images in tqdm.tqdm(dataloader, desc="Classifying platform")
